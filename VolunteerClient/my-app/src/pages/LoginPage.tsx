            ...
            <form onSubmit={login}>
              <div className="ll-fields">
                <div className="ll-f">
                  ...
                  <input className="ll-inp" type="email" name="email" placeholder="you@email.com" required />
                </div>
                <div className="ll-f">
                  <label className="ll-lbl">Password</label>
                  <input className="ll-inp" type="password" name="password" placeholder="Your password" required />
                </div>
              </div>

              <button className="ll-btn" type="submit">Sign In →</button>

              <p className="ll-foot">
                Don't have an account?{' '}
<Link to={Paths.register}>Join the community</Link>              </p>
            </form>
          </div>
        </div>
